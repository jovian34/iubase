...
from player_tracking.choices import HAND_CHOICES, TRANSACTION_CHOICES, POSITION_CHOICES, STATUS_CHOICES
...
class AnnualRoster(models.Model):
    ...
    secondary_position = models.CharField(choices=POSITION_CHOICES, null=True, blank=True)

    def __str__(self) -> str:
        return f"{self.player.first} {self.player.last} {self.fall_year} - {self.status}"
